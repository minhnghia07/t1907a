...
if (!empty($_POST)) {
	...
	if ($_username != '' && $_password != '' && $_password == $_confirmation_pwd) {
		$sql = "insert into userr(userName,email,fullname,phone,password) values ('$_username','$_email','$_fullname','$_phone','$_password')";
		execute($sql);
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form method="post" action="">
					...
					<a class="btn btn-danger" href='javascript: history.go(-1)'>Come back</a>
				</form>		
			</div>
		</div>
	</div>
